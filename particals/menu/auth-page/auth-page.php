<div class="menu__content">
  ...
  <form action="/<?= $path ?>/authorisation/login.php" method="POST" class="auth__form form__login">
  ...
  <form action="/<?= $path ?>/authorisation/register.php" method="POST" class="auth__form form__register">
